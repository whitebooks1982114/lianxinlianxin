//
//  SendBoxTableViewController.swift
//  廉兴连心
//
...
class SendBoxTableViewController: UITableViewController {
    
    var list = [String]()
    
    let detailContent = DetailSendContentViewController()
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        detailContent.detailTitle = selectedTitle
